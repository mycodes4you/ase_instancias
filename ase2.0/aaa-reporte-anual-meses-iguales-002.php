...
$preg = "SELECT orden_id, orden_vehiculo_id, orden_asesor_id, orden_grua, orden_servicio, orden_estatus, orden_fecha_recepcion FROM " . $dbpfx . "ordenes WHERE orden_id >= '$orden' LIMIT 500";
