...
elseif(defined("L_LANG") && L_LANG != "es_MX" && L_LANG != "L_LANG") $language = L_LANG;
$language = 'es_MX';
if(isset($language)){
...
<div id="calendar-page">
    <div id="calendar-header" align="center">
        ...
        <?php } ?>
        <form id="calendarform" class="form-control" name="calendarform" method="post" action="<?php echo($thispage);?>">
          <table align="center" cellpadding="1" cellspacing="0">
			...
			if ($first_input == "B"){
			?>
              <td align="left"><select class="form-control" name="m" onchange="javascript:submitCalendar();">
              <?php
			...
			?>
              <td align="left"><select class="form-control" name="y" onchange="javascript:submitCalendar();">
              <?php
              $thisyear = date('Y');
			...
			if ($second_input == "B"){
			?>
              <td align="right"><select class="form-control" name="m" onchange="javascript:submitCalendar();"">
              <?php
              for($f=1; $f<=sizeof($monthnames); $f++){
                $selected = ($f == (int)$m) ? " selected" : "";
                echo("<option value=\"".str_pad($f, 2, "0", STR_PAD_LEFT)."\"$selected>".$monthnames[$f-1]."</option>");
			...
			?>
              <td align="right"><select class="form-control" name="y" onchange="javascript:submitCalendar();">
              <?php
              $thisyear = date('Y');
