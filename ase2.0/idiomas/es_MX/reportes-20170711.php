...
'Area' => 'Area',
'Asesor' => 'Asesor',
'ayuda_perdida_ganancia' => 'Esta columna contiene el resultado de la siguiente fórmula:<br><br>
		Número de horas estimadas<br> 
		<big>-</big><br> 
		Número de horas utilizadas <br>
		<big>-</big><br>
		Número de horas totales usadas en los reprocesos<br> 
		<big>=</big><br>
		Horas que ahorró ó horas que se excedió el Operador.<br><br>
		<p class="rojo_tenue">Si este recuadro tiene el fondo de este color, se debe a que se excedió el límite de pérdida o de ganacia. Se puede fijar un margen de pérdida, pero también uno de ganancia para identificar las tareas terminadas en segundos, lo cual indica que posiblemente no se registró el tiempo correcto.</p>',
'Bienvenida' => 'Bienvenida',
'Bodega' => 'Bodega',
'Carga en Horas' => 'Carga en Horas',
'Cliente' => 'Cliente',
...
'DiasP' => 'Días en proceso',
'En Almacén' => 'En Almacén',
'Entregado a' => 'Con',
'Entregado' => 'Entregado a Cliente',
'Estatus' => 'Estatus',
'Estatus de Cobro' => 'Estatus de Cobro',
'EstatusOT' => 'Ubicación del Vehículo',
'Estatus de Reparación' => 'Estatus de Reparación',
'EstaRep' => 'No Iniciado',
'EstaRep1' => 'Trabajando',
'EstaRep2' => 'Detenido',
'EstaRep5' => 'Trabajando',
'EstaRep7' => 'Terminado por Aprobar',
'Evaluada?' => 'Evaluada?',
...
'FechaPromesa' => 'Fecha Promesa de Entrega',
'FechaE' => 'Fecha Entregado',
'FechaR' => 'Fecha Recibido',
'FechaUM' => 'Fecha Último Movimiento',
...
'Garantía' => 'Garantía',
'Historial de comentarios' => 'Historial de comentarios',
'Horas estimadas' => 'Horas estimadas',
'Horas utilizadas' => 'Horas utilizadas',
'Instaló' => 'Instaló',
'Interno' => 'Interno',
'Item' => 'Cantidad y Descripción',
'Mano de Obra Autorizada' => 'Mano de Obra Autorizada',
'MO' => 'M.O.',
'MO AUTORIZADA SIN OPERARIO' => 'AUTORIZADA SIN OPERARIO',
'Monto Pagado' => 'Monto Pagado',
'Monto por Pagar' => 'Monto por Pagar',
'No Aplica' => 'No requiere Refacciones',
'Normal' => 'Normal',
'Operario' => 'Operario',
...
'Refacciones Recibidas' => 'Refacciones Recibidas',
...
'Tipo Item' => 'Tipo de Producto',
'Tiempo de reproceso' => 'Tiempo de reproceso',
'Todos' => 'Todos',
