...
'Costo de' => 'Costo de',
'Cuenta' => 'Cuenta',
'Debes de seleccionar un operador' => 'Debes de seleccionar un operador',
...
'Pagados' => 'Pagados',
'Pago' => 'Pago',
'pagos_adelantados' => 'Pagos adelantados',
...
$ayuda = [
	$lang['ayuda_recibos'] => '			<h1>' . $lang['ayuda_recibos'] . '</h1>
			<div id="body">
				<div id="principal">
					Para poder eliminar un recibo, es necesario que a su usuario se le configure un permiso para poder eliminarlo. Si al tratar de eliminar el recibo le aparece el mensaje <span style="background-color:red; font-weight:bold;">Acceso NO autorizado, ingresar Usuario y Clave correcta</span> es que no tiene permiso y debe solicitarlo a su gerente.<br>
					<br>Una vez que tiene permiso activo, para eliminar un recibo de destajo primero debemos desasociar o quitar los pagos y/o descuentos que se han aplicado a este recibo de destajo. Una vez que el recibo de destajos está libre aparece el botón "Eliminar Recibo" con lo que se liberarán las tareas que estén asociadas a éste y las tareas ahora se podrán agregar a un nuevo recibo de destajo.<br>
