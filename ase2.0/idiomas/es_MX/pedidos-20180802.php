...
define('PEDIDO_ESTATUS_20','Recibido con Factura(s) registrada(s)');
define('PEDIDO_ESTATUS_25','Factura(s) registrada(s) con pagos parciales');
define('PEDIDO_ESTATUS_30','Pagado sin registro de factura(s)');
...
$PedidoEstatus = [
	...
	'20' => 'Recibido con Factura(s) registrada(s)',
	'25' => 'Factura(s) registrada(s) con pagos parciales',
	'30' => 'Pagado sin registro de factura(s)',
	'50' => 'Por Devolver',
