...
define('COM_TIPO_0', 'Comentario General Interno');
define('COM_TIPO_1', 'Enviar Comentario al Cliente');
define('COM_TIPO_2', 'Registrar llamada al Cliente');
define('COM_TIPO_3', 'Mensaje a Usuario');
define('COM_TIPO_5', 'Vigilancia');
// define('COM_TIPO_', '');

$lang = array(
'com_tipo_0' => 'Comentario General Interno',
'com_tipo_1' => 'Enviar Comentario al Cliente',
