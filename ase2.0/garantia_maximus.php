<?php
	...
	<table cellpadding="0" cellspacing="0" border="0" class="centrado mediana" width="850">
		...
		<tr><td colspan="7">&nbsp;</td></tr>
		<tr style="background-color:black; color:white; font-weight:bold;"><td>&nbsp;</td><td>MARCA</td><td>TIPO</td><td>MODELO</td><td>PLACAS</td><td>KILOMETRAJE</td><td>&nbsp;</td></tr>
		...
		echo '		<tr><td>';
		echo '			<p><i>MAXIMUS BODY SHOP, S DE R.L. garantiza los trabajos y reparaciones realizados a consecuencia del siniestro o trabajos particulares autorizados por el cliente, según sea EL CASO:</i></p>
			<table cellpadding="0" cellspacing="0" border="0" class="izquierda" width="850">
				<tr><td colspan="7">&nbsp;</td></tr>
				<tr><td colspan="7">&nbsp;</td></tr>
				<tr><td style="width:150px;">&nbsp;</td><td>&nbsp;</td><td>1.- Laminado</td><td style="width:100px;">&nbsp;</td><td>60 días naturales.</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>2.- Pintura</td><td>&nbsp;</td><td>60 días naturales.</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td colsapn="3">3.- Mecánica</td><td>&nbsp;</td><td>60 días naturales o 100 Km, lo que ocurra primero.</td></tr>
				<tr><td colspan="7">&nbsp;</td></tr>
				<tr><td colspan="7">&nbsp;</td></tr>
			</table><br>
			...
			<ul>
				...
				<li>b. <b>NO</b> ampara daños por uso, desgaste natural en las piezas de mecánica del vehúculo.</li>
			...
			<p>En caso de requerirse algún servicio bajo los términos de esta garantía, El cliente deberá<br>llamar al teléfono de atención a clientes al <b>46.17.32.82</b><br>
			Las reparaciones por garantía serán efectuadas sin costo y para hacerse válida deberá<br>presentar éste documento.<br><br><br><br>
Atte.</p>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr><td style="text-align:center;"><br>Gerencia<br>MAXIMUS BODY SHOP</td><td style="text-align:center;"><br><br>FIRMA ENTERADO CLIENTE</td></tr>
				...
				<tr><td colspan="2" style="text-align:center;">CALZADA DEL HUESO # 777. COL. GRANJAS COAPA, DEL. TLALPAN, MÉXICO, D.F. C.P. 14330<br>'.$agencia_email.'</td></tr>
			</table>
