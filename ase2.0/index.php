...
// --------- Bloque de Mensajes Internos ------------------
	...
	if($mensjint == '1') {
	echo '			
					<div style="float:left; width:240px; background-color: #c9c9c9; margin-top: 3px; margin-right: 3px; margin-bottom: 4px;">'."\n";
      		...
      		echo '				
				...
				while($comen = mysql_fetch_array($matrc1)) {
					...
					if($comen['orden_id'] == '9999995' ) {
						...
						echo '									' . $provid[1] . '<br>'."\n";
						echo '									<button name="visto" value="' . $comen['bit_id'] . '|' . $provid[0] . '|1" type="submit">' . $lang['CotAcept'] . '</button><br>'."\n";
						echo '									<button name="visto" value="' . $comen['bit_id'] . '|' . $provid[0] . '|0" type="submit">' . $lang['CotPosp'] . '</button><br>'."\n";
						echo '									<button name="visto" value="' . $comen['bit_id'] . '|' . $provid[0] . '|2" type="submit">' . $lang['CotBloq'] . '</button><br>'."\n";
...
// --------- Bloque de Vehículos en Proceso ------------------
	...
	echo '			<div style="clear: both;"></div><div class="bloque_1">
						<table cellpadding="0" cellspacing="0" border="1" width="100%" class="bloque_fila centrado">
							<tr class="cabeza_tabla">
