...
//			echo 'Copia y Pega desde AUDATEX las <span style="color:#f00; font-weight:bold;">PIEZAS SUSTITUIDAS que tienen precio</span>:';
			echo '
								Copia y Pega desde AUDATEX las <span style="color:#f00; font-weight:bold;">PIEZAS SUSTITUIDAS</span><br>O agrega directamente las refacciones, una por renglón: 
								<br><big><span style="color:#f00; font-weight:bold;">Descripción, Código (al menos 8 letras o números sin espacio) Precio Público (si no sabe el precio colocar un # en lugar del precio)</span></big><br>
								EJEMPLO:<br>
								<b>JGO 4 GUIAS FASCIA TRASERA KL12345678 $350.50</b>';
		} else {
