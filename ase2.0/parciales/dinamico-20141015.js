...
function validarExp() {
   ...
   if( document.rapida.servicio[3].checked && document.rapida.levante.value == "")
   {
...
*/
   ...
   if( document.rapida.deducible.value == "" )
   {
     alert( "Por favor indique si Paga o no Deducible" );
     document.rapida.deducible.focus() ;
     return false;
   }
