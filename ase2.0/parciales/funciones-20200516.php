...
// ------ Selección individual de archivos a descargar o eliminar
			...
			while ($documento = mysql_fetch_array($matriz)) {
                                ...
                                if(!file_exists(DIR_DOCS . $documento['doc_archivo'])) {
					$_SESSION['msjerror'] = 'No existe ' . $documento['doc_archivo'] . '<br>';
                                        $archivo = $dbpfx . '/' . $documento['doc_archivo'];
                                        ...
                                        $tmp_img = file_get_contents($urlFirmada);
                                        if($tmp_img != '') {
                                                file_put_contents(DIR_DOCS . $documento['doc_archivo'], $tmp_img);
                                        }
                                }
