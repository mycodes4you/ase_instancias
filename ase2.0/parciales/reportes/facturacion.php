...
if ($f1125100 == '1' || $_SESSION['rol02']=='1' || $_SESSION['rol12']=='1') {
	...
	if($cliente != '') {
		...
		$matrase = mysql_query($pregase) or die("ERROR: Fallo selección de lapso! 15 " . $pregase);
		...
		if($filaase > 0) {
			...
			$matrcli = mysql_query($pregcli) or die("ERROR: Fallo selección de lapso! 26 " . $pregcli);
	...
	$matr0 = mysql_query($preg0) or die("ERROR: Fallo selección de lapso! 103 " . $preg0);
