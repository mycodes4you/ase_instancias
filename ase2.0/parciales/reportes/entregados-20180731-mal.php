...
if ($f1125090 == '1' || $_SESSION['rol02']=='1' || $_SESSION['rol03'] == '1' || $_SESSION['rol04'] == '1' || $_SESSION['rol06'] == '1') {
	...
	$preg1 = "SELECT o.orden_id, o.orden_grua, o.orden_vehiculo_color, o.orden_vehiculo_tipo, o.orden_vehiculo_placas, o.orden_estatus, o.orden_servicio, o.orden_fecha_recepcion, o.orden_fecha_de_entrega, o.orden_fecha_promesa_de_entrega, o.orden_fecha_proceso_fin, o.orden_asesor_id FROM " . $dbpfx . "subordenes s, " . $dbpfx . "ordenes o  WHERE o.orden_id = s.orden_id AND s.sub_estatus < '190' ";

	if($tipo_reparacion == 'reparados'){
		$preg1 .= " AND (o.orden_estatus <= '29' OR o.orden_estatus = '99') ";
	} elseif($tipo_reparacion == 'no_reparados'){
		$preg1 .= " AND ((o.orden_estatus >= '30' AND o.orden_estatus <= '98') OR o.orden_estatus = '210') ";
	}

	if($estatus_cerrado != ''){
		$preg1 = " SELECT o.orden_id, o.orden_grua, o.orden_vehiculo_color, o.orden_vehiculo_tipo, o.orden_vehiculo_placas, o.orden_estatus, o.orden_servicio, o.orden_fecha_recepcion, o.orden_fecha_de_entrega, o.orden_fecha_promesa_de_entrega, o.orden_fecha_proceso_fin, o.orden_asesor_id FROM " . $dbpfx . "subordenes s, " . $dbpfx . "ordenes o  WHERE o.orden_id = s.orden_id AND  o.orden_estatus = '" . $estatus_cerrado . "' ";
	}

	if($tipo_fecha == 'fech_termino'){
		if($estatus_cerrado != '5' && $estatus_cerrado != '6'){ // --- entregado con refacciones pendientes ---
			$preg1 .= " AND o.orden_fecha_proceso_fin >= '" . $feini . "' AND o.orden_fecha_proceso_fin <= '" . $fefin . "'";
		}
	} else {
		if($estatus_cerrado != '5' && $estatus_cerrado != '6'){ // --- entregado con refacciones pendientes ---
			$preg1 .= " AND o.orden_fecha_de_entrega >= '" . $feini . "' AND o.orden_fecha_de_entrega <= '" . $fefin . "'";
		}
	}
