		...
		echo '			
			<table cellspacing="1" cellpadding="2" border="0">
				<tr class="cabeza_tabla">
					<td colspan="19" style="text-align: right;">' . $filas . $encabezado . '</td>
				</tr>
				<tr>
					<td>OT</td>
					<td>Vehículo</td>
					...
					<td>Estatus</td>
					<td>Siniestro</td>
					<td class="area7">Deducible</td>
					<td class="area7" style="text-align:center;">Cobrado?</td>
					<td class="area7" style="text-align:center;">F Cobrado</td>
				</tr>'."\n";
		$fondo = 'claro';
	}
...
//					$dedu_fech = $fact['fact_fecha_emision'] . ' ';
			...
			if($export == 1){ // ---- Hoja de calculo ----
				...
				$objPHPExcel->setActiveSheetIndex(0)
							->setCellValue($f, $dedu)
							->setCellValue($g, $dedu_cob)
							->setCellValue($h, $fech_deducob);
				$z++;
				...
				echo '
					<td class="area7" style="text-align:right;">
						<a href="entrega.php?accion=cobros&orden_id=' . $ord['orden_id'] . '" target="_blank">$' . number_format($dedu, 2) . '</a>
					</td>
					<td class="area7">' . $dedu_cob . '</td>
					<td class="area7">' . $fech_deducob . '</td>
				</tr>'."\n";
