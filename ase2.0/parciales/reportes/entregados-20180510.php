...
if ($f1125090 == '1' || $_SESSION['rol02']=='1' || $_SESSION['rol03'] == '1' || $_SESSION['rol04'] == '1' || $_SESSION['rol06'] == '1') {
	...
	$preg1 = "SELECT o.orden_id, o.orden_grua, o.orden_vehiculo_color, o.orden_vehiculo_tipo, o.orden_vehiculo_placas, o.orden_estatus, o.orden_servicio, o.orden_fecha_recepcion, o.orden_fecha_de_entrega, o.orden_fecha_promesa_de_entrega, o.orden_fecha_proceso_fin, o.orden_asesor_id FROM " . $dbpfx . "subordenes s, " . $dbpfx . "ordenes o  WHERE o.orden_id = s.orden_id AND s.sub_estatus < '190' AND ";
	
	if($tipo_fecha == 'fech_termino'){
		$preg1 .= " o.orden_fecha_proceso_fin >= '" . $feini . "' AND o.orden_fecha_proceso_fin <= '" . $fefin . "'";
	} else {
		$preg1 .= " o.orden_fecha_de_entrega >= '" . $feini . "' AND o.orden_fecha_de_entrega <= '" . $fefin . "'";
	}
			...
			if($export == 1){ // ---- Hoja de calculo ----    
				...
				echo '				
						<tr class="' . $fondo . '">
							...
							<td style="text-align: left !important;">' . strtoupper($ord['orden_vehiculo_tipo']) . ' ' . strtoupper($ord['orden_vehiculo_color']) . '
							</td>
