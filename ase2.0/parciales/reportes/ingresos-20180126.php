		...
		while($ord = mysql_fetch_array($matr0)){
			...
			if($asegflt != ''){
				...
				if($aseguradora_encontrada == 1){
					...
					// --- revisar si la orden cumple para ser mostrada --
					if($ord['orden_estatus'] != '17' && $ord['orden_estatus'] != '90'){
						
						//echo "la orden " . $ord['orden_id'] . " es candidata para ser mostrada<br>";
						
					}else{
	
						//echo "la orden " . $ord['orden_id'] . " <b>no</b> es candidata para ser mostrada<br>";
						$oculta = 'si';
					}
			...
			echo '		
					<tr>
						<td colspan="2" style="vertical-align: top;">
							<h2>Total Ordenes: <big><b>' . $tot_ord_proc . '</big></h2>
						</td>
