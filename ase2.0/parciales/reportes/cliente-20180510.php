...
<div class="page-content">
	<div class="row"> <!-box header del título. -->
		...
		foreach($ase as $k => $v) {
			...
			$fondo = 'claro';
			$j = 0;
			$pregpo = "SELECT s.orden_id, o.orden_fecha_de_entrega FROM " . $dbpfx . "subordenes s, " . $dbpfx . "ordenes o  WHERE s.sub_aseguradora = '" . $k . "' AND o.orden_id = s.orden_id AND s.sub_estatus < '190' AND ";
			if($estatusflt == 1) {
