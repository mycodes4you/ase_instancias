...
# echo 'RFC Receptor: ' .  $repgen['ReceptorRfc'] . '<br>';
...
// echo $cfdi . '<br>';
//echo htmlspecialchars($cfdi);
file_put_contents(DIR_DOCS . 'rpe-temporal-1.xml', $cfdi);
...
//echo htmlspecialchars($cfdi);
file_put_contents(DIR_DOCS . 'rpe-temporal-2.xml', $cfdi);
...
file_put_contents(DIR_DOCS . 'rpe-temporal-3.xml', $cfdi);
