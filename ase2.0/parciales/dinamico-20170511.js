...
/*
   if( document.rapida.servicio[3].checked && document.rapida.orden_adm.value == "" && document.rapida.levante.value == "1")
   {
     alert( "Por favor agregue imagen de la Orden de admisión" );
     document.rapida.orden_adm.focus() ;
     return false;
   }
   if( document.rapida.levante.value == "" && document.rapida.admdocs.value == "1")
   {
